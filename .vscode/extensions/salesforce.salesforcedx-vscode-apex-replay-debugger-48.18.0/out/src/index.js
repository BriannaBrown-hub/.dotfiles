...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        context.subscriptions.push(commands, debugHandlers, debugConfigProvider, checkpointsView, breakpointsSub);
        // Telemetry
...
function getDialogStartingPath() {
    if (vscode.workspace.workspaceFolders &&
        ...
        // if it exists.
        const sfdxCommandLogDir = path.join(vscode.workspace.workspaceFolders[0].uri.fsPath, '.sfdx', 'tools', 'debug', 'logs');
