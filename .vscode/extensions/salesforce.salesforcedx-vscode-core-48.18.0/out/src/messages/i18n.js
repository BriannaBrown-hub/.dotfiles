...
exports.messages = {
    ...
    predicates_no_sfdx_project_found_text: 'No sfdx-project.json found in the root directory of your open project. Open a Salesforce DX project in VS Code.',
    ...
    isv_debug_bootstrap_open_project: 'Opening project in new Visual Studio Code window',
    ...
    error_no_scratch_def: 'No scratch definition files found. These files must be in the "config" folder and have file names that end with "-scratch-def.json". See [Scratch Org Definition File](https://developer.salesforce.com/docs/atlas.en-us.sfdx_dev.meta/sfdx_dev/sfdx_dev_scratch_orgs_def_file.htm) for help.',
    ...
    conflict_detect_retrieve_org_source: 'Conflict Detection: retrieving org source',
    conflict_detect_convert_org_source: 'Conflict Detection: converting org source',
    conflict_detect_conflicts_during_deploy: 'Conflicts are detected while deploying metadata. Select Override Conflicts to proceed or Cancel to view the conflicts.',
    ...
    force_source_diff_command_not_found: 'To run this command, first install the @salesforce/sfdx-diff plugin. For more info, see [https://forcedotcom.github.io/salesforcedx-vscode/articles/user-guide/source-diff](https://forcedotcom.github.io/salesforcedx-vscode/articles/user-guide/source-diff).',
