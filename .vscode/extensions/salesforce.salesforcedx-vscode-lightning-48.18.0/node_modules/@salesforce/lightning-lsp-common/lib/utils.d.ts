 ...
 */
export declare function includesDeletedLwcWatchedDirectory(context: WorkspaceContext, changes: FileEvent[]): boolean;
export declare function includesDeletedAuraWatchedDirectory(context: WorkspaceContext, changes: FileEvent[]): boolean;
