...
class TestRunner {
    ...
    getShellExecutionInfo() {
        const workspaceFolder = index_1.getTestWorkspaceFolder(this.testExecutionInfo.testUri);
        if (workspaceFolder) {
            ...
            if (jestExecutionInfo) {
                ...
                const lwcTestRunnerExecutable = index_1.getLwcTestRunnerExecutable(cwd);
                let cliArgs;
                if (this.testRunType === "debug" /* DEBUG */) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (shellExecutionInfo) {
                ...
                if (this.logName) {
                    ...
                    sfdxTask.onDidEnd(() => {
                        telemetry_1.telemetryService.sendCommandEvent(this.logName, startTime).catch();
                    });
                }
