...
class StreamingClient extends kit_1.AsyncOptionalCreatable {
    ...
    constructor(options) {
        ...
        const instanceUrl = ts_types_1.ensure(this.options.org.getConnection().getAuthInfoFields().instanceUrl);
        /**
        ...
        this.cometClient.addExtension({
            outgoing: (message, callback) => {
                if (message.channel === '/meta/subscribe') {
                    ...
                    kit_1.set(message, 'ext.replay', replayFromMap);
                }
                callback(message);
            }
        });
    ...
    incoming(message, cb) {
        ...
        if (message &&
            ...
            message.error &&
            ts_types_1.ensureString(message.error).includes('400::API version in the URI is mandatory')) {
