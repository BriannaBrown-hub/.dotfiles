...
class Connection extends jsforce_1.Connection {
    ...
    static async create(options) {
        const _aggregator = options.configAggregator || (await configAggregator_1.ConfigAggregator.create());
     ...
     */
    async init() {
        this.logger = this._logger = this.tooling._logger = await logger_1.Logger.child('connection');
    }
    /**
