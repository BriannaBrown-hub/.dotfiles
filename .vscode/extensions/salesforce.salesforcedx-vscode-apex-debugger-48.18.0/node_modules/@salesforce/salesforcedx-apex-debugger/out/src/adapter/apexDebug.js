        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (args.connectType === CONNECT_TYPE_ISV_DEBUGGER) {
                    const forceConfig = yield new cli_1.ForceConfigGet().getConfig(args.sfdxProject, src_1.SFDX_CONFIG_ISV_DEBUGGER_SID, src_1.SFDX_CONFIG_ISV_DEBUGGER_URL);
                    const isvDebuggerSid = forceConfig.get(src_1.SFDX_CONFIG_ISV_DEBUGGER_SID);
                    const isvDebuggerUrl = forceConfig.get(src_1.SFDX_CONFIG_ISV_DEBUGGER_URL);
